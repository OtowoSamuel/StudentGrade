...
contract StudentGrades {
    ...
    // Admin functions
    function addStudent(address _studentAddress, string memory _name, uint256 _score) public onlyAdmin {
        ...
        students[_studentAddress] = Student({name: _name, score: _score, exists: true});
    ...
    function updateGrade(address _studentAddress, uint256 _newScore) public onlyAdmin studentExists(_studentAddress) {
        if (_newScore > 100) {
